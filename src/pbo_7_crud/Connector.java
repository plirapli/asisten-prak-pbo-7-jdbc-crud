...
public class Connector {
    ...
    public List<Mahasiswa> getAll() {
        ...
        try {
            ...
            */
            ...
            /* 
                Karena hasil query memiliki tipe data List, supaya dapat mencetak semua data student,
    ...
    void insert(String nama, String nim){
        ...
        try {
            ...
            String query = "INSERT INTO students (nama, nim) VALUES (?,?);";
            ...
            */
            ...
            // Menampilkan pop-up jika input data berhasil
    ...
    public void update(String nama, String nim, int id) {
        ...
        try {
            // Perintah query disimpan ke dalam variabel "query"
            String query = "UPDATE students SET nama=?, nim=? WHERE id=?;";
